...
def _get_video_metadata(video_id: str) -> None:
    ...
    try:
        ...
        new_video_metadata = YoutubeVideoMetadata(
            ...
            video.publish_date)
        logging.info(
            f"Video metadata: {video.video_id}, {video.title}, {video.author}, {video.length}, "
...
def init() -> None:
    ...
    app_directory_config = AppDirectoryConfiguration(
...
video_id_str.trace(
    ...
    index,
    mode,
    video_id=video_id_str: _get_video_metadata(video_id))
