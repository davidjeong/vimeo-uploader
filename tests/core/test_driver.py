...
def test_download_youtube_resources_and_combine(tmpdir) -> None:
    ...
    tmp_video_path = get_absolute_path(tmpdir, 'video_stream.mp4')
    tmp_audio_path = get_absolute_path(tmpdir, 'audio_stream.mp3')
    ...
    combined_path = get_absolute_path(tmpdir, "combined_video.mp4")
    final_path = get_absolute_path(tmpdir, "final_video.mp4")
